...
public class Information {
	...
	private void initialize() {
		...
		tabbedPane.addTab("Leave", null, panel_2, null);
		...
		textField.setBounds(405, 14, 55, 20);
		panel_2.add(textField);
		textField.setColumns(10);
		
		JLabel lblLeave = new JLabel("Available Leaves");
		lblLeave.setBounds(278, 17, 117, 14);
		panel_2.add(lblLeave);
		
		JButton btnNewButton_2 = new JButton("New button");
		btnNewButton_2.setBounds(278, 138, 182, 32);
			...
			public void itemStateChanged(ItemEvent e) {
				if(comboBox.getSelectedItem().equals("1111")) {
					try {
						...
						BufferedReader readerEmp = new BufferedReader(
								new FileReader("C:\\Users\\clari\\eclipse-workspace\\EmployeeApp2\\src\\Files\\employee1111.csv"));
						
						//Reads the CSV file data separated by "," and display the data to their respective textfields
						...
						//Payroll
						//Reads the CSV file from local directory
						BufferedReader readerPay = new BufferedReader(
								new FileReader("C:\\Users\\clari\\eclipse-workspace\\EmployeeApp2\\src\\Files\\payroll1111.csv"));
					...
					try {
						//Reads the CSV file from local directory
						BufferedReader readerEmp = new BufferedReader(
								new FileReader("C:\\Users\\clari\\eclipse-workspace\\EmployeeApp2\\src\\Files\\employee2222.csv"));
						...
						//Reads the CSV file from local directory
						BufferedReader readerPay = new BufferedReader(
								new FileReader("C:\\Users\\clari\\eclipse-workspace\\EmployeeApp2\\src\\Files\\payroll2222.csv"));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(comboBox.getSelectedItem().equals("....")) {
					...
					try {
						...
						//Reads the data that separated by "," and updates there values from the textfield
						while(line != null) {
						...
						BufferedWriter writer = new BufferedWriter(
								new FileWriter("C:\\Users\\clari\\eclipse-workspace\\EmployeeApp2\\src\\Files\\employee1111.csv"));
					...
					try {
						...
						//Updating the CSV file
						BufferedWriter writer = new BufferedWriter(
								new FileWriter("C:\\Users\\clari\\eclipse-workspace\\EmployeeApp2\\src\\Files\\employee2222.csv"));
						//Writes the appended data to the CSV file
						writer.write(dataUpdate.toString());
						writer.flush();
						writer.close();
